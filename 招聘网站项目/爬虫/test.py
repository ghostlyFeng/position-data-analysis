...
def max_page_get(job, city):
    ...
    cookies = {
        ...
        'JSESSIONID': 'ABAAABAAAIAACBI87BA7CF76F6B70C642CDBA93DE4CE402',
        '_gid': 'GA1.2.1288368152.1531635625',
        'TG-TRACK-CODE': 'index_search',
        '_gat': '1',
        'LGSID': '20180716160342-c136503b-88ce-11e8-9ac4-525400f775ce',
        'PRE_UTM': '',
        'PRE_HOST': '',
        'PRE_SITE': 'https%3A%2F%2Fwww.lagou.com%2Fjobs%2Flist_python%25E6%2595%25B0%25E6%258D%25AE%25E5%2588%2586%25E6%259E%2590%3FlabelWords%3D%26fromSearch%3Dtrue%26suginput%3D',
        'PRE_LAND': 'https%3A%2F%2Fwww.lagou.com%2Fjobs%2Flist_python%25E6%2595%25B0%25E6%258D%25AE%25E5%2588%2586%25E6%259E%2590%3Fpx%3Ddefault%26gj%3D3%25E5%25B9%25B4%25E5%258F%258A%25E4%25BB%25A5%25E4%25B8%258B%26city%3D%25E5%258C%2597%25E4%25BA%25AC',
        'LGRID': '20180716161206-ee101577-88cf-11e8-9ac4-525400f775ce',
        'Hm_lpvt_4233e74dff0ae5bd0a3d81c6ccf756e6': '1531728727',
        'SEARCH_ID': 'dcba98a77cd64829b9f0fb7dada777c4'
    }
...
if __name__ == '__main__':
    ...
    s.trust_env = False
    s.verify = False
    jobs_li = ['python爬虫', 'Django','python数据分析', 'python算法工程师', 'python数据挖掘', '数据挖掘', '深度学习', '机器学习']
    city_li = ['北京', '上海', '深圳', '广州', '杭州', '成都', '武汉', '南京', '西安']
    exp_li = ['3年及以下','3-5年','5-10年','不要求']
    edu_li = ['大专', '本科', '硕士','博士','不要求']
    with open('lagou.csv', 'wt', encoding='utf-8') as f:
        field_li = ['positionName','workYear','education','jobNature','financeStage','industryField','companyShortName','companyFullName','city','salary','district','createTime','positionLables','companySize','firstType','secondType','isSchoolJob']
